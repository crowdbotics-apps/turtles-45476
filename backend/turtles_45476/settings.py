"""
Django settings for turtles_45476 project.
...
ROOT_URLCONF = 'turtles_45476.urls'
...
WSGI_APPLICATION = 'turtles_45476.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "turtles_45476 API",
    "DESCRIPTION": "API documentation for turtles_45476 App",
    "VERSION": "v1",
}
